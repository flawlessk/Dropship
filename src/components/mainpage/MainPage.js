  ...
  return (
    <div className="page-wrapper">
          ...
          <div className="header-right">
            <div className="right-menu">
              <ul className="menu-list">
                ...
                <li>
                  <a className="sign-up-btn" target="_blank" href="/register">
                    SIGN UP NOW
                  </a>
                </li>
                <li>
                  <a className="log-in-btn" target="_blank" href="/login">
                    LOGIN
                  </a>
                </li>
              </ul>
      ...
      <div className="baner-wrapper">
        ...
        <a className="sign-up-click" href="/register">
          SIGN UP NOW
        </a>
      </div>
        ...
        <div className="section-heading">
          ...
          <div>
            <h4 className="section-heading-title">
              <span>
                <strong>
                  PARTNER WITH THE MOST EXPERIENCED DROPSHIPPING TEAM IN THE
                  INDUSTRY!
                </strong>
              </span>
            </h4>
        ...
        <div className="section-text">
          <div className="text-wrapper">
            <span className="text-span">
              ...
              <span className="text-spans">
                POINT OF CONTACT PROVIDING TOP DROPSHIP PRODUCTS FROM WORLDWIDE
                SUPPLIERS
              </span>
            </span>
          </div>
            ...
            <div className="row__heading">
              ...
              <div className="heading__text">
                <p>
                  ...
                  Dropship products available on various niches. 365DROPSHIP
                  product catalog covers an extensive selection from some of the
